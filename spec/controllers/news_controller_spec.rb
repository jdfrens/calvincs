...
describe NewsController do
  ...
  context "index action" do
    it "should show listing and news items" do
      ...
      assigns[:last_updated].should == news_items(:another_todays_news).updated_at
  ...
  context "list action" do
    ...
    it "should list by this year" do
      get :list, { :id => current_year }
    
      assert_response :success
      assigns[:title].should == "News of #{current_year}"
      assigns[:last_updated].should == news_items(:another_todays_news).updated_at
    ...
    it "should list by last year" do
      get :list, { :id => current_year - 1 }
    
      assert_response :success
      assigns[:title].should == "News of #{current_year - 1}"
    ...
    it "should list by year in past" do
      get :list, { :id => current_year - 2 }
    
      assert_response :success
      assigns[:title].should == "News of #{current_year - 2}"
      assigns[:last_updated].should == news_items(:past_news).updated_at
    ...
    context "when logged in" do
      it "should list this year" do
        get :list, { :id => current_year }, user_session(:edit)

        assert_response :success
        assigns[:title].should == "News of #{current_year}"
        assigns[:last_updated].should == news_items(:future_news).updated_at
        assert_news_listing(current_year)
        assert_select "div#news-listing table[summary=news items]" do
